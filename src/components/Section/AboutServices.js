...
const AboutServices = () => {
  ...
  return (
    <Container dir="auto">
      <Comp data-aos="zoom-in" data-aos-delay={200}>
        {/* <img src={Side} alt="side"></img>
        <div className="paragraphe-service">
          {/* <Hedear >
          {t("ABOUT.SERVICES-Sheelni.ABOUT-SERVICE.title1")}
            <div
              className="line-service"
              style={{ width: 50, border: "1px solid black", height: 0 }}
            ></div>
          </Hedear> 
          <Title> {t("ABOUT.SERVICES-Sheelni.ABOUT-SERVICE.title2")}</Title>

          <Descrip>
            {t("ABOUT.SERVICES-Sheelni.ABOUT-SERVICE.desc1")}
            <br />

            {t("ABOUT.SERVICES-Sheelni.ABOUT-SERVICE.desc2")}
          </Descrip>
        </div> */}
        <AboutSection>
          {/* ------------------------------------------------------------------- */}
      ...
      // `}
        ...
        <Badge data-aos="zoom-in">
          ...
          <Middle>
            ...
            <HeadingUp data-aos="zoom-in">
              {t("ACCEUILE.ÉTAPES.title2")}
            </HeadingUp>
